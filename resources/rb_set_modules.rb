...
def usage
  ...
  printf "Available modules: ips, flow, monitor, api, location, malware, social, correlation_engine_rule, policy_enforcer"
end
...
if ARGV.length >= 1 
  ...
  ARGV.each do |x|
    ...
    if name=="ips" or name=="flow" or name=="monitor" or name=="api" or name=="all" or name=="location" or name=="malware" or name=="social" or name=="correlation_engine_rule" or name=="policy_enforcer"
