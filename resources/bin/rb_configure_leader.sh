...
function configure_leader(){
  ...
  listCookbooks="zookeeper kafka druid http2k cron memcached chef-server consul hadoop samza nginx geoip webui snmp rbmonitor rb-manager" # The order matters!
