...
function configure_leader(){
  ...
  listCookbooks="zookeeper kafka druid http2k memcached chef-server consul hadoop samza nginx geoip webui snmp mongodb rbmonitor rbscanner ntp f2k logstash pmacct minio postgresql dswatcher events-counter rsyslog rbsocial rb-manager" # The order matters!
