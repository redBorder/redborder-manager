...
_RBEOF_
  # monitors rBglobal
  FLOW_DEFAULT_MONITOR_CATS=$(cat <<EOF
[
  "kafka_disk_cached_pages",
  "cache_hits",
  "enrichmentstreamtask_messages",
  "flowprocessor_messages",
  "locationprocessor_messages",
  "nmspprocessor_messages",
  "monitorprocessor_messages",
  "memory_bytes",
  "memory_available",
  "disk_bytes",
  "hot_tier_capacity",
  "default_tier_capacity",
  "broker_query_success",
  "broker_cache_size",
  "broker_query_time",
  "broker_query_return_size",
  "broker_failed_query",
  "broker_timeout_query",
  "broker_interrupted_query",
  "broker_query_count",
  "historical_segmet_time",
  "historical_query_time",
  "historical_wait_time",
  "historical_segment_pending_count",
  "historical_query_cpu_time",
  "historical_segment_count",
  "historical_pending_request",
  "historical_failed_query",
  "historical_timeout_query",
  "historical_interrupted_query",
  "historical_query_count",
  "historical_query_success",
  "system_temp",
  "peripheral_temp",
  "pch_temp",
  "fan",
  ...
  "wire_bits_per_sec_realtime",
  "pkt_drop_percent",
  "alerts_per_second",
  "new_sessions_per_second",
  "patmatch_percent",
  "packets_wire_per_sec_realtime",
  "total_sessions",
  "snort_cpu",
  ...
  "router_latency",
  "router_pkts_lost",
  "router_pkts_percent_rcv",
  "dns_latency",
  "dns_pkts_lost",
  "dns_pkts_percent_rcv",
  "dns_query_latency",
  "dns_query_lost",
  "wireless_stations",
  "redfish_thermal_temperature_cpu_average",
  "redfish_thermal_temperature_cpu_health",
  "redfish_thermal_fan_health",
  "redfish_thermal_temperature_intake_average",
  "redfish_thermal_temperature_intake_health",
  "redfish_power_powercontrol_averageconsumedwatts",
  "redfish_power_powerredundancy_health",
  "redfish_power_powersupply_health",
  "redfish_thermal_temperature_powersupply_average",
  "redfish_thermal_temperature_powersupply_health",
  "redfish_thermal_temperature_systemboard_average",
  "redfish_thermal_temperature_systemboard_health",
  "redfish_thermal_temperature_front_health",
  "redfish_thermal_temperature_networkingdevices_health",
  "redfish_thermal_fan_speed",
  "memory_zookeeper",
  "memory_webui",
  "memory_f2k",
  "memory_redborder_nmsp",
  "memory_n2klocd",
  "memory_http2k",
  "memory_kafka",
  "memory_druid_coordinator",
  "memory_druid_middleManager",
  "memory_druid_overlord",
  "memory_druid_broker",
  "memory_druid_realtime",
  "memory_druid_historical",
  "cpu",
  "disk",
  "disk_load",
  "load_1",
  ...
  cat > /var/chef/data/data_bag/rBglobal/monitors.json <<-_RBEOF_
{
  ...
  "monitors": "$FLOW_DEFAULT_MONITOR_CATS"
}
